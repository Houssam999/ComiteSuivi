...
It measures segment widths and saves visualizations of the processed images.
It also computes the fractal dimension for each segment.
"""
...
def find_segments(skeleton, labeled_nodes, label_to_position):
    ...
    for label in range(1, num_labels):
        ...
        if len(node_labels) >= 2:
            ...
            # Find the two farthest points in the segment
...
def process_frame(args):
    ...
    for idx_segment, segment in enumerate(segments, start=1):
        ...
        # Add segment information, including start and end positions
        segment_info = {
            'Frame': frame_idx + 1,
    ...
    # Create DataFrames for nodes, segments, and fractal dimensions
